...
const showcaseCache = fs.readFileSync(require.resolve('../showcase-cache.js'), 'utf8');
assert.match(appSource, /@app\.route\('\/health'\)/);
assert.match(appSource, /return 'ok', 200/);
assert.match(appSource, /@app\.route\('\/en'\)/);
assert.match(appSource, /@app\.route\('\/showcase-cache\.js'\)/);
...
assert.match(html, /advanced-console\.js\?v=20260906-1/);
assert.match(html, /showcase-cache\.js/);
assert.match(showcaseCache, /GachaShowcaseCache/);
assert.match(showcaseCache, /actualRuns: 1000/);
...
assert.match(require('node:fs').readFileSync(require.resolve('../advanced-console.js'), 'utf8'), /renderCachedQuickAnalysis/);
assert.match(require('node:fs').readFileSync(require.resolve('../advanced-console.js'), 'utf8'), /GachaShowcaseCache/);
